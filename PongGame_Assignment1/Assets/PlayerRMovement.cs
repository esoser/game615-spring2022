...
public class PlayerRMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.I) && transform.position.y < 3.50f)
        {
            transform.Translate(new Vector3(0, speed, 0));
        }

        if (Input.GetKey(KeyCode.K) && transform.position.y > -3.50f)
        {
            transform.Translate(new Vector3(0, -speed, 0));
        }

        if (Input.GetKey(KeyCode.J) && transform.position.x > 2f)
        {
            transform.Translate(new Vector3(-speed/2, 0, 0));
        }


        if (Input.GetKey(KeyCode.L) && transform.position.x < 8f)
        {
            transform.Translate(new Vector3(speed/2, 0, 0));
        }
